#!/usr/bin/gnuplot
reset
set output "../fig/app-netperf.eps"
set terminal postscript "Helvetica" eps enhance dl 2 color size 3.3,2.5
set pointsize 1
...
#set xlabel "(a) Netperf" font ",30" offset 0, -2
set xlabel " " font ",30" offset 0, -3.2
set label "(a) Netperf" at  -0.0,-0.35 front rotate by 0 font ",30"

set ylabel "Normalized Overhead" offset -6,-1 font ",28"
